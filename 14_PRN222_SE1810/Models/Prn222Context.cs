...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=TEPKAKA\\TEPKAKA;Initial Catalog=PRN222; Trusted_Connection=SSPI;Encrypt=false");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<About>(entity =>
        {
            entity.HasKey(e => e.AboutId).HasName("PK__About__717FC93C3E2E8916");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__product___47027DF5ACCC7918");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__product___3213E83FF8E4D7D1");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductComments)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__product_c__produ__07C12930");

            entity.HasOne(d => d.User).WithMany(p => p.ProductComments)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__product_c__user___08B54D69");
        });

        modelBuilder.Entity<ProductSaleOff>(entity =>
        {
            entity.HasKey(e => e.SaleId).HasName("PK__product___E1EB00B2D890CAA7");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductSaleOffs)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__product_s__produ__09A971A2");
        });
        ...
        {
            entity.HasKey(e => e.IdReport).HasName("PK__report__D8639F521501461F");
